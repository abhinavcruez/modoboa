"""
Django settings for mymodoboa project.
...
SECRET_KEY = '0aif0szoo70=^h_7*-hxb1mvz9$b3c4tu6_s*krw3sl%di@l_3'
...
ROOT_URLCONF = 'mymodoboa.urls'

WSGI_APPLICATION = 'mymodoboa.wsgi.application'
...
STATICFILES_DIRS = (
    '/home/abhi/modoboa/modoboa-env/lib/python3.10/site-packages/modoboa/bower_components',
)
